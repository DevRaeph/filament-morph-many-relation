...
class CarrierResource extends Resource
{
    ...
    protected static ?string $slug = 'carriers';
        ...
        return $form
            ->schema([
                ...
                Placeholder::make('created_at')
                    ->label('Created Date')
                    ->content(fn(?Carrier $record): string => $record?->created_at?->diffForHumans() ?? '-'),

                Placeholder::make('updated_at')
                    ->label('Last Modified Date')
                    ->content(fn(?Carrier $record): string => $record?->updated_at?->diffForHumans() ?? '-'),
            ]);
    }
